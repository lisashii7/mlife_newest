        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            @include('partial.topbar')
                ...
                <div class="container-fluid">
                    ...
                    <form method="POST" action="/dashboard/buku/update/{{$data['id_buku']}}">
                    @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="title">Judul Buku</label>
                                    <input type="text" class="form-control" id="title" name="buku" value="{{$data['buku']}}">
                                </div>
                                <div class="form-group">
                                    <label for="deskripsi">Deskripsi</label>
                                    <input type="text" class="form-control" id="deskripsi" name="keterangan" value="{{$data['keterangan']}}">
                                </div>
                                <div class="form-group">
