            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tambah Detail Kemajuan</h1>
                    </div>
                    ...
                    <form method="POST" action="/dashboard/detailKemajuan/tambah">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="id_kemajuan" name="id_kemajuan" required>
                                        ...
                                        <option value="{{ $kemajuan->id_kemajuan }}">{{ $kemajuan->id_kemajuan }}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="id_bab" name="id_bab" required>
                                        <option value=""></option>
                                        @foreach ($babs as $bab)
                                        <option value="{{ $bab->id_bab }}">{{ $bab->bab }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
